...
with tf.Graph().as_default():
    ...
    with sess.as_default():
        ...
        while True:
            ...
            # frame = cv2.resize(frame, (1500,700), fx=0.5, fy=0.5)    #resize frame (optional)
            timer = time.time()
            if frame.ndim == 2:
                        ...
                        if best_class_probabilities > 0.60:
                            ...
                            for H_i in HumanNames:
                                if HumanNames[best_class_indices[0]] == H_i:
                                    ...
                                    cv2.rectangle(
                                        frame, (xmin, ymin-20), (xmax, ymin-2), (0, 255, 255), -1)
            ...
            cv2.putText(frame, "fps: {:.2f}".format(
                fps), (20, 50), cv2.FONT_HERSHEY_SIMPLEX, 0.7, (0, 0, 0), 2)
